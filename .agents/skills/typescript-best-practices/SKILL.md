...
description: TypeScript best practices. Use when editing TypeScript or reviewing TypeScript correctness and design.
---
...
| Real tests | Choose tests that exercise the changed behavior. Verify relevant visual and interaction changes in a running build. Use mocks when isolation makes the test more useful. |
